...
<html>
    <head>
        ...
        <title><s:message code="global.update"/> <s:message code="global.menu.depart"/></title>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <form:form action="depart/save.htm" modelAttribute="depart">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <form:input cssClass="form-control" maxlength="10" path="name"/>
