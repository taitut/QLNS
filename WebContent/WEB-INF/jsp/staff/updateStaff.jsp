...
<html>
    <head>
        ...
        <title><s:message code="global.update"/> <s:message code="global.menu.staff"/></title>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <form:form action="staff/save.htm" modelAttribute="staff" enctype="multipart/form-data">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label"><s:message code="global.ma"/></label>
                                                                    <div class="col-sm-10">
                                                                        <form:input cssClass="form-control" readonly="true" path="ma" />
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
